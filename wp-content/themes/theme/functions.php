...
function odin_enqueue_scripts() {
	...
	// jQuery.
	wp_enqueue_script( 'odin-jquery', $template_url . '/assets/libraries/jquery/dist/jquery.min.js', array(), null, true );

	// Main jQuery.
	wp_enqueue_script( 'odin-main', $template_url . '/assets/scripts/all.min.js', array(), null, true );
...
function odin_stylesheet_uri( $uri, $dir ) {
	return $dir . '/assets/stylesheets/main.css';
}
...
if( function_exists('acf_add_options_page') ) {
	...
	$option_page = acf_add_options_page(array(
		'page_title' 	=> 'Opcões do tema',
		'menu_title' 	=> 'Opcões do tema',
...
add_filter ( 'upload_mimes' ,  'svgUploads' ) ;
/**
 ...
 */
$slider = new Odin_Post_Type(
    'Pessoa', // Nome (Singular) do Post Type.
    'pessoas' // Slug do Post Type.
);
$slider->set_arguments(
    array(
        'supports' => array( 'title', 'editor', 'thumbnail' ),
